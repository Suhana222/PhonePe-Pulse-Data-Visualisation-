...
if select == "Home":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\aashi\Desktop\YoutubeProject\download.jpg"),width= 500)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\aashi\Desktop\YoutubeProject\image.jpg"),width=490)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\aashi\Desktop\YoutubeProject\img1.jpg"),width= 500)
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        if method == "Insurance Analysis":
            ...
            col1,col2= st.columns(2)
            with col1:
                quarters= st.slider("**Select the Quarter**",1, int(df_agg_insur_Y["Quarter"].min()), int(df_agg_insur_Y["Quarter"].max()),int(df_agg_insur_Y["Quarter"].min()))
    ...
    with tab2:
        ...
        if method_map == "Map Insurance Analysis":
            ...
            col1,col2= st.columns(2)
            with col1:
                quarters_m1= st.slider("**Select the Quarter_mi**",1, int(df_map_insur_Y["Quarter"].min()), int(df_map_insur_Y["Quarter"].max()),int(df_map_insur_Y["Quarter"].min()))
    ...
    with tab3:
        ...
        if method_top == "Top Insurance Analysis":
            ...
            col1,col2= st.columns(2)
            with col1:
                quarters_t1= st.slider("**Select the Quarter_ti**",1, int(df_top_insur_Y["Quarter"].min()), int(df_top_insur_Y["Quarter"].max()),int(df_top_insur_Y["Quarter"].min()))
