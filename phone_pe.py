    ...
    with tab1:
        ...
        if method == "Insurance Analysis":
            ...
            with col1:
                ...
                quarters= st.slider("Select The Quarter",1,int(tac_Y["Quarter"].min()), int(tac_Y["Quarter"].max()),int(tac_Y["Quarter"].min()))
    ...
    with tab2:
        ...
        if method_2 == "Map Insurance":
            ...
            with col1:
                ...
                quarters= st.slider("Select The Quarter_mi",1,int(map_insur_tac_Y["Quarter"].min()), int(map_insur_tac_Y["Quarter"].max()),int(map_insur_tac_Y["Quarter"].min()))
    ...
    with tab3:
        ...
        if method_3 == "Top Insurance":
            ...
            with col1:
                ...
                quarters= st.slider("Select The Quarter_mu",1,int(top_insur_tac_Y["Quarter"].min()), int(top_insur_tac_Y["Quarter"].max()),int(top_insur_tac_Y["Quarter"].min()))
